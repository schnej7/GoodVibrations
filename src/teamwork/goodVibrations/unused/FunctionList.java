...
public class FunctionList
{
  ...
  // populates an array of ints with ids from every function in the list of
  // functions
  ...
  // returns a list of strings populated with the name of each function in the
  // list of functions
  ...
  // populates an array of strings with the name of each function in the list of
  // functions
