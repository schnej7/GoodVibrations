...
public class TimeTriggerSetDaysActivity extends Activity
{
  ...
  protected void onStart()
  {
    ...
    try
    {
      ...
      if((Utils.getDayOfWeekBitMask(1) & daysActive) != 0) chkSunday.setChecked(true);
      if((Utils.getDayOfWeekBitMask(2) & daysActive) != 0) chkMonday.setChecked(true);
      if((Utils.getDayOfWeekBitMask(3) & daysActive) != 0) chkTuesday.setChecked(true);
      if((Utils.getDayOfWeekBitMask(4) & daysActive) != 0) chkWednesday.setChecked(true);
      if((Utils.getDayOfWeekBitMask(5) & daysActive) != 0) chkThursday.setChecked(true);
      if((Utils.getDayOfWeekBitMask(6) & daysActive) != 0) chkFriday.setChecked(true);
      if((Utils.getDayOfWeekBitMask(7) & daysActive) != 0) chkSaturday.setChecked(true);
